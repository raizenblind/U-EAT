            ...
            <div class="card">
                ...
                <div class="carousel carousel-slider" data-indicators="true">
                    ...
                    <a class="carousel-item" href="#one!">
                        <img src="https://lorempixel.com/800/400/food/1"></a>
                    <a class="carousel-item" href="#two!">
                        <img src="https://lorempixel.com/800/400/food/2"></a>
                    <a class="carousel-item" href="#three!">
                        <img src="https://lorempixel.com/800/400/food/3"></a>
                ...
                <div class="card-content">
                    ...
                    <span class="grey-text darken-3">
                        <ul class="collection">
                            ...
                            <li class="collection-item">Discount does not apply to kids for the buffet - Discount does not apply to beverages</li>
                            <li class="collection-item">Lunch Buffet is from <span class="red-text">12:00 to 14:30</span></li>
                            <li class="collection-item">Dinner Buffet is from <span class="red-text">18:00 to 22:00</span></li>
                            <li class="collection-item">A la carte is from <span class="red-text">15:00 - 17:30</span></li>
                            <li class="collection-item">Discount is valid for dine-in only</li>
                        </ul>

                    </span>

                    <span class="card-title">Address
                    </span>
